...
name_mapping = {'Asian_black_bear': '亚洲黑熊', 'Bos_taurus': '家牛', 'Capra_aegagrus_hircus': '家羊',
                'Ailurus_fulgens': '小熊猫', 'Siberian_weasel': '黄鼬', 'Tibetan_macaque': '藏酋猴',
               'Ailuropoda_melanoleuca': '大熊猫', 'Canis_lupus_familiaris': '狗', 'Hystrix_brachyura_hodgsoni': '豪猪',
               'Leopard_cat': '豹猫', 'Masked_palm_civet_or_gem-faced civet': '果子狸'}
...
class DetThread(QThread):
    ...
    def __init__(self):
        ...
        self.weights = './11species.pt'
        self.current_weight = './11species.pt'
        self.source = '0'
...
class MainWindow(QMainWindow, Ui_mainWindow):
    ...
    def show_statistic(self, statistic_dic):
        try:
            ...
            results = [' ' + name_mapping[str(i[0])] + '：' + str(i[1]) for i in statistic_dic]
