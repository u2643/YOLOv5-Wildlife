...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/icon/BRL.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.groupBox_18.setStyleSheet("#groupBox_18{border-image: url(:/img/icon/brl_bg.png);\n"
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/BRL.png);")
...
"")
        ...
        self.out_video.setLayoutDirection(QtCore.Qt.LeftToRight)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "YOLOv5动物目标检测"))
        self.label_4.setText(_translate("mainWindow", "AI与守护"))
        self.label_5.setText(_translate("mainWindow", "使用设置"))
        ...
        self.rtspButton.setToolTip(_translate("mainWindow", "网络资源"))
        self.label_2.setText(_translate("mainWindow", "IoU设置"))
        self.label.setText(_translate("mainWindow", "置信度设置"))
        self.label_8.setText(_translate("mainWindow", "延迟设置"))
        self.checkBox.setText(_translate("mainWindow", "开/关"))
        self.saveCheckBox.setText(_translate("mainWindow", "自动保存"))
        self.label_11.setText(_translate("mainWindow", "检测结果统计"))
        self.label_6.setText(_translate("mainWindow", "检测结果展示"))
